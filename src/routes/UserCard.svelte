...
<section id="user-card">
  <div class="cover">
    <div class="flex items-start pt-20 pb-20 h-auto lg:items-center lg:pt-0 lg:pb-0 lg:pl-48 lg:my-0 lg:h-screen">
      <div class="mx-auto max-w-lg bg-white bg-opacity-90 rounded-xl shadow-2xl transition duration-300 ease-in-out lg:max-w-3xl dark:bg-gray-800 container-border">
...
<style lang="postcss">
  ...
  .profile-image {
    @apply block mx-auto bg-center bg-cover
    rounded-xl
    w-48 h-48 border-2
